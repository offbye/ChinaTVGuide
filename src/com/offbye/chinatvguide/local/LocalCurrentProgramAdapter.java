...
public class LocalCurrentProgramAdapter extends ArrayAdapter<TVProgram> {

	int resource;
	Context context;

	public LocalCurrentProgramAdapter(Context _context, int _resource,
...

	{
		...
		TextView channelnameView = (TextView) todoView.findViewById(R.id.channelname);
...
//				+ ".png"));
		...
		dateView.setText(item.getStarttime() + " -- " +item.getEndtime());
